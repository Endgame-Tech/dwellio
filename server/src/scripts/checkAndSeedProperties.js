  ...
  try {
    ...
    if (propertyCount > 0) {
      ...
      properties.forEach((prop, idx) => {
        ...
        console.log(
          `   Approval Status: ${
            prop.approvalStatus || "NOT SET (will default to pending)"
          }`
        );
    ...
    if (propertyCount === 0) {
      ...
      const testProperties = [
        {
          ...
          description:
            "Beautiful 3-bedroom flat with modern amenities in the heart of Lekki.",
          bedrooms: 3,
          bathrooms: 3,
          area: 150,
          rent: {
      ...
      console.log("\n💡 Tip: Use the landlord panel to approve properties");
    }

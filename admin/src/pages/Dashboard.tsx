  ...
  const loadDashboardData = async () => {
    try {
      ...
      const [usersChart, propertiesChart, applicationsChart, paymentsChart] = await Promise.all([
        adminApi.getChartData('users'),
        adminApi.getChartData('properties'),
        adminApi.getChartData('applications'),
        adminApi.getChartData('payments'),
      ]);
  ...
  const statsCards: StatsCard[] = [
    {
      ...
      href: hasPermission('users.read') ? '/admin/users' : undefined,
    },
    {
      ...
      href: hasPermission('properties.read') ? '/admin/properties' : undefined,
    },
    {
      ...
      href: hasPermission('applications.read') ? '/admin/applications' : undefined,
    },
    {
      ...
      href: hasPermission('payments.read') ? '/admin/payments' : undefined,
    },
  ];
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        {statsCards.map((card) => (
          <div key={card.title} className="admin-card admin-card-hover">
            <div className="p-6">
              ...
              <div className="mt-4">
                ...
                <div className="flex items-baseline justify-between">
                  <p className="admin-stats-number">{card.value}</p>
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {hasPermission('users.create') && (
              <Link to="/admin/users/new" className="admin-btn-primary text-center">
                Add New User
              </Link>
            )}
            {hasPermission('properties.create') && (
              <Link to="/admin/properties/new" className="admin-btn-primary text-center">
                Add New Property
              </Link>
            )}
            {hasPermission('settings.write') && (
              <Link to="/admin/settings" className="admin-btn-secondary text-center">
                System Settings
              </Link>
            )}
          </div>

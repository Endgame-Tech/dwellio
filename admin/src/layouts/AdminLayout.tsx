...
const sidebarItems: SidebarItem[] = [
  ...
  { name: 'Users', href: '/admin/users', icon: FiUsers, permission: 'users.read' },
  { name: 'Properties', href: '/admin/properties', icon: FiMapPin, permission: 'properties.read' },
  { name: 'Applications', href: '/admin/applications', icon: FiFileText, permission: 'applications.read' },
  { name: 'Payments', href: '/admin/payments', icon: FiDollarSign, permission: 'payments.read' },
  { name: 'Maintenance', href: '/admin/maintenance', icon: FiTool, permission: 'maintenance.read' },
  { name: 'Analytics', href: '/admin/analytics', icon: FiBarChart, permission: 'analytics.read' },
  { name: 'Activity Logs', href: '/admin/activity', icon: FiActivity, permission: 'logs.read' },
  { name: 'Settings', href: '/admin/settings', icon: FiSettings, permission: 'settings.read' },
];
        ...
        <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
          {filteredSidebarItems.map((item) => (
            <Link
              ...
              className={`admin-nav-item ${isActive(item.href) ? 'admin-nav-item-active' : 'admin-nav-item-inactive'
                }`}
            >

...
export interface User {
  ...
  lastLoginAt?: string;
  address?: string;
  landlordRole?: 'landlord' | 'alpha_landlord' | 'super_landlord' | 'moderator' | 'analyst';
  // Permissions can be a flat list of permission strings or structured by resource/action for landlords
...
// Landlord User Type (extends User for landlord-specific fields)
